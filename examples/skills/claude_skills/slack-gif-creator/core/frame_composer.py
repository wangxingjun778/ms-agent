...
def draw_circle(
    ...
    draw.ellipse(
        bbox, fill=fill_color, outline=outline_color, width=outline_width)
    return frame
...
def draw_star(
    ...
    for i in range(10):
        angle = (i * 36
                 - 90) * math.pi / 180  # 36 degrees per point, start at top
    ...
    # Draw star
    draw.polygon(
        points, fill=fill_color, outline=outline_color, width=outline_width)
