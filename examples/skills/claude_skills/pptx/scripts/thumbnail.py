...
def main():
    ...
    parser.add_argument(
        ...
        default='thumbnails',
        help=
        'Output prefix for image files (default: thumbnails, will create prefix.jpg or prefix-N.jpg)',
    )
    parser.add_argument(
        '--cols',
        type=int,
...
def create_grid(
    ...
    grid_h = rows * (height + font_size
                     + label_padding * 2) + (rows + 1) * GRID_PADDING
    ...
    for i, img_path in enumerate(image_paths):
        ...
        with Image.open(img_path) as img:
            ...
            if placeholder_regions and (start_slide_num
                                        + i) in placeholder_regions:
                ...
                for region in regions:
                    ...
                    stroke_width = max(
                        5,
                        min(orig_w, orig_h)
                        // 150)  # Thicker proportional stroke width
